...
export const routes: Routes = [
  ...
  {
    path: 'seleccion-habitacion',
    loadComponent: () => import('./components/landing/seleccion-habitacion/seleccion-habitacion.component').then(m => m.SeleccionHabitacionComponent)
  },
  {
    path: 'login',
